...
public class DeleteBlogPostCommandTest
{
    ...
    public async Task Handle_Should_CallRepositoryGetById()
    {
        ...
        // Assert
        await _blogPostRepositoryMock.Received(1).GetById(Arg.Any<int>());
    }
    ...
    public async Task Handle_Should_CallRepositoryGetByIdAndDelete()
    {
        ...
        // Assert
        await _blogPostRepositoryMock.Received(1).GetById(Id);
        _blogPostRepositoryMock.Received(1).Delete(BlogPost);
    }
